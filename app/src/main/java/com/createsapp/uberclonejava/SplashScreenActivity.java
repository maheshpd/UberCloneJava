...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private void showRegisterLayout() {
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(edit_first_name.getText().toString().trim())) {
                    Toast.makeText(SplashScreenActivity.this, "Please enter first name", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(edit_last_name.getText().toString().trim())) {
                    Toast.makeText(SplashScreenActivity.this, "Please enter last name", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(edit_phone_number.getText().toString().trim())) {
                    ...
                    model.setPhoneNumber(edit_phone_number.getText().toString().trim());
                    model.setRating(0.0);
    ...
    private void showLoginLayout() {
        AuthMethodPickerLayout authMethodPickerLayout = new AuthMethodPickerLayout
                .Builder(R.layout.layout_sign_iin)
